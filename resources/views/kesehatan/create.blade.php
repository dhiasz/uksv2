    ...
    <div class="max-w-4xl mx-auto mt-10 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
        ...
        <form action="{{ route('kesehatan.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama" id="nama" class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:text-gray-200" value="{{ old('nama') }}" placeholder="Masukan Nama siswa" required>
                @error('nama')
            ...
            <div class="mb-4">
                ...
                <input type="number" name="umur" id="umur" min="15" max="250" class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:text-gray-200" value="{{ old('umur') }}" required>
                @error('umur')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
           ...
           {{-- Tinggi Badan --}}
            <div class="mb-4">
                ...
                <input type="number" name="tb" id="tb" min="100" max="250" class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:text-gray-200" value="{{ old('tb') }}" required>
                @error('tb')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="bb" id="bb" min="40" max="180" class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:text-gray-200" value="{{ old('bb') }}" required>
                @error('bb')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
