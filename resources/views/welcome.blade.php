...
<header class="fixed top-0 left-1/2 transform -translate-x-1/2 
  ...
  <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between gap-10">
    ...
    <!-- Statistik -->
    <div class="w-full md:w-40 shadow border rounded-[10px] p-1 text-sm">
      <h4 class="text-base font-semibold mb-2 text-center">Bisa Diisi<br><span class="font-bold underline">Portal UKS</span></h4>
