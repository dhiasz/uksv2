...
<header class="fixed top-0 left-1/2 transform -translate-x-1/2 
    ...
    <div class="flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <img src="logo-uks.png" alt="Logo UKS" class="w-10 h-10">
  ...
  <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between gap-10">
    ...
    <div class="flex flex-col items-center md:items-start text-center md:text-left">
      <img src="logo-uks.png" alt="Logo UKS" class="w-20 mb-2">
      <p class="font-semibold">SMK Negeri 1 Cipanas UKS</p>
    </div>

    <!-- Kontak -->
    <div class="flex-2">
      <h4 class="text-base font-semibold mb-2">Kontak</h4>
      <ul class="space-y-1 text-sm">
        <li class="flex items-start"><span class="mr-2">🏢</span>SMK Negeri 1 Cipanas</li>
        <li class="flex items-start"><span class="mr-2">📍</span>Jalan Raya, Cimacan, Kecamatan Cipanas, Kabupaten Cianjur, Jawa Barat, kode pos 43253</li>
        <li class="flex items-start"><span class="mr-2">🌐</span><a href="https://smkn1cipanas.sch.id/" class="">smkn1cipanas.sch.id</a></li>
        <li class="flex items-start"><span class="mr-2">🌐</span><a href="https://www.instagram.com/pmrsmkn1cipanas/" class="">www.instagram.com/pmrsmkn1cipanas/</a></li>
      </ul>
    </div>
