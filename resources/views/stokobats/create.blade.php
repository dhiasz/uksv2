    ...
    <div class="max-w-4xl mx-auto mt-10 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
        ...
        <form action="{{ route('stokobats.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="jumlah" id="jumlah" value="{{ old('jumlah') }}" class="w-full px-4 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" required>
                @error('jumlah')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('stokobats.index') }}" class="px-4 py-2 bg-gray-500 text-white font-semibold rounded-lg hover:bg-gray-600 transition">Kembali</a>
