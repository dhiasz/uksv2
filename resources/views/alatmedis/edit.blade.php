<x-app-layout>
    <div class="max-w-4xl mx-auto mt-10 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
        ...
        <form action="{{ route('alatmedis.update', $alatmedis->id) }}" method="POST">
            ...
            {{-- Kode Alat Medis --}}
            <div class="mb-4">
                <label for="kode" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">
                    Kode Alat
                </label>
                <input
                    type="text"
            ...
            {{-- Kondisi --}}
            <div class="mb-4">
                <label for="kondisi" class="block text-gray-700 dark:text-gray-300 font-medium mb-2">
                    Kondisi
                </label>
                <select
                    name="kondisi"
                ...
                >
                    ...
                    <option value="Sedang" {{ old('kondisi', $alatmedis->kondisi) == 'Sedang' ? 'selected' : '' }}>Sedang</option>
                    <option value="Rusak" {{ old('kondisi', $alatmedis->kondisi) == 'Rusak' ? 'selected' : '' }}>Rusak</option>
